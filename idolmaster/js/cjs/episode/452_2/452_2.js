...
(lib.bg = function() {
	this.initialize(img._452_2_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1056,1400);


(lib.book1 = function() {
	this.initialize(img._452_2_book1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1056,1400);


(lib.book2 = function() {
	this.initialize(img._452_2_book2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1056,1400);


(lib.ch_face2 = function() {
	this.initialize(img._452_2_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,252);


(lib.ch_face3 = function() {
	this.initialize(img._452_2_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,252);


(lib.ch_face4 = function() {
	this.initialize(img._452_2_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,252);


(lib.ch_face5 = function() {
	this.initialize(img._452_2_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,252);


(lib.ch_face6 = function() {
	this.initialize(img._452_2_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,252);


(lib.ch_face7 = function() {
	this.initialize(img._452_2_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,252);


(lib.finish = function() {
	this.initialize(img._452_2_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._452_2_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._452_2_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._452_2_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
p.nominalBounds = new cjs.Rectangle(0,0,528,700);
...
}).prototype = getMCSymbolPrototype(lib.character1_face_eyeclose, new cjs.Rectangle(0,0,146,126), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,528,700), null);
...
(lib.mc_shine = function(mode,startPosition,loop) {
	...
	// レイヤー_1
	this.instance = new lib.shine("single",0);
	this.instance.parent = this;
	this.instance.setTransform(132,175,0.5,0.5,0,0,0,264,350);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},29,cjs.Ease.quadInOut).to({alpha:0},30,cjs.Ease.quadInOut).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,264,350);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AhEAJIAAgRICJAAIAAARg");
	this.shape.setTransform(80,0.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AhFA1IAAgRICLAAIAAARgAg3gjIAAgRIBwAAIAAARg");
	this.shape_1.setTransform(64,0.775);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("AArA9IAAgIIhoAAIAAgRIBoAAIAAhPIhmAAIAAgRIB4AAIAAB5g");
	this.shape_2.setTransform(47.85,0.95);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("AhLA6QALgJAIgMQAHgLAFgOQADgMABgOQACgOAAgOIAAgMIgBgMIASAAIAAALQAAAdgCAWQgDAVgIASQgIASgQAPgAAAAgIAAggIAAhDIARAAIAAAMIAAARIAAAVIgBAVIAAAVIAAAPQAMgFAIgKQAJgJAGgMQAIgLAEgMIANAPQgFAJgGAMQgIALgJAKQgKAKgMAIQgMAHgOADIAAgig");
	this.shape_3.setTransform(32.15,0.525);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("AhNBBQAMgQAJgSQAJgUAFgUQAGgUACgUIATACQgDAXgGAVQgGAUgIATQgIAUgKAQgAArAbIgPgmQgIgTgJgQIARgGIAOAcIANAeIALAdQAFAOACAMIgTAHQgEgVgHgUgAArgtIgKgMIAKgGIAJAMIAJANIgKAGIgIgNgAA8g3IgJgLIAJgFIAJALIAJANIgJAGIgJgOg");
	this.shape_4.setTransform(16.15,-0.2);
	...
	this.shape_5.setTransform(0.125,0.975);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("AhAAvQAbgEATgJQATgHAOgNQANgMAJgQQAIgRAGgVIAQAKIgHAXQgGANgIAMQgHAMgOAMQgNAKgSAKQgUAJgbAFgAgigeIgRgLIgPgIIAMgOIAKAGIANAHIANAJIALAJIgMAPQgHgGgIgHg");
	this.shape_6.setTransform(-15.6,0.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("AAjA0IAAgGIhVAAIAAgPIBVAAIAAgdIhPAAIAAgNIBPAAIAAgaIhTAAIAAgOIBjAAIAABng");
	this.shape_7.setTransform(-32.075,2.275);
	...
	this.shape_8.setTransform(-47.725,0.65);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#333333").s().p("AhAAvQAbgEAUgJQASgHANgNQAOgMAJgQQAJgRAEgVIARAKIgIAXQgEANgJAMQgIAMgMAMQgNAKgTAKQgUAJgbAFgAgigeIgRgLIgPgIIANgOIAKAGIAMAHIANAJIALAJIgMAPQgHgGgIgHg");
	this.shape_9.setTransform(-63.6,0.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#333333").s().p("");
	this.shape_10.setTransform(-80,0.75);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("ArFJ2IAAzXIWfAAIAATXg");
	mask.setTransform(73,63);
	...
	this.instance_6.parent = this;
	this.instance_6.setTransform(1,1,0.5,0.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).to({state:[]},4).wait(9));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-70,184);
...
p.nominalBounds = new cjs.Rectangle(2,2,144,124);
...
(lib.window = function(mode,startPosition,loop) {
	...
	// dummy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(55.925,11.825);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(40.225,11.525);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AgcA8QgNgEgIgGQgGgGgDgFQgCgGAAgFQAAgGACgFQADgGAFgFIATAHQgEADgBADIgCAGQAAAFAGAEQAFAEAKABQAKACAMAAQANAAAOgCQAOgBAOgFIABAYQgNAEgOABIgZACQgXAAgOgEgAAYgoIgagBIgbABIgWADIgBgXIAagCIAbgBIAZABQANABAMACIgBAWIgagDg");
	this.shape_2.setTransform(23.95,12.225);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("AnmGSIg7hfIAKiLIBmhNICvg3IDtAIIDhhmICGggIDKAlICABUIAbA4IgfBtIgkAlIhuARIhNAWIh5AKIixgKIiJApIhtA5IgIAKIgnAQIglAJIgqAAIh5ANIhVAVg");
	var mask_graphics_21 = new cjs.Graphics().p("AisDxIhKhTIADgkQADgiABABIAUh1ICTgHIBJASICLBEIB5AeIAkgFQgUA6AABQQgBAfACAaIhEgGIi6Agg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:69.525,y:43.9}).wait(6).to({graphics:mask_graphics_21,x:29.75,y:29.75}).wait(6));

	// character1_face_close_container
	this.instance = new lib.character1_face_eyeclose();
	this.instance.parent = this;
	this.instance.setTransform(36,31,1,1,0,0,0,35,30);
	this.instance.alpha = 0.1992;
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).wait(1).to({alpha:1},0).wait(1).to({regX:73,regY:63,x:74,y:64,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:36,y:31,alpha:0},0).wait(2).to({alpha:0.1992},0).wait(1).to({alpha:1},0).wait(1).to({regX:73,regY:63,x:74,y:64,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:36,y:31,alpha:0},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:73,regY:63,x:73,y:63,alpha:0.6436},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0.9102},0).to({alpha:1},1).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:73,regY:63,x:73,y:63,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-190,-212,528,700);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-191,-172);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-311,-568,621.2,700);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-123.15,-373.75,1.1645,1.1645);
	this.instance._off = true;

	this.instance_1 = new lib.heart();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-128.65,-365.75,0.4532,0.4532);
	this.instance_1.alpha = 0;
	this.instance_1.compositeOperation = "lighter";
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-148.75,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-160.4,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-123.15,y:-373.75,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-148.75,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-160.4,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,rotation:0,x:-123.15,y:-373.75,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-148.75,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-160.4,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-123.15,y:-373.75,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-148.75,y:-382.75,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-160.4,y:-387.05,alpha:0.2188},0).to({_off:true},1).wait(110));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-130.4,y:-379.9,alpha:0.375},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-133.65,y:-385.75,alpha:0.5},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-131.1,y:-383.6,alpha:0.4444},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-130.55,y:-380.35,alpha:0.2778},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-131.65,y:-375.75,alpha:0},0).to({_off:true},1).wait(66));

	// effect
	this.instance_2 = new lib.spread_flower_pink("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-37.8,-301.7,1.4808,1.4808);

	this.instance_3 = new lib.good_effect("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(-37.8,-301.7,1.481,1.481);

	this.instance_4 = new lib.notice();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-142,-370.95,1.187,1.187,0,-169.8305,10.1695,-29.1,20.4);
	this.instance_4._off = true;

	this.instance_5 = new lib.laugh("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-145.85,-383.75,1.4204,1.4204,35.8424,0,0,-30.2,20.6);
	this.instance_5._off = true;

	this.instance_6 = new lib.chord("synched",0,false);
	this.instance_6.parent = this;
	this.instance_6.setTransform(-102.6,-304.1,1.0029,1.0029,-61.4995,0,0,-23.4,76.9);

	this.instance_7 = new lib.question();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-139.65,-362.7,1.053,1.053,-28.4906);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.instance_8 = new lib.mc_exclamation("synched",0,false);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-127.6,-390.4,1.0929,1.0929,-29.9996,0,0,0,0.1);

	this.instance_9 = new lib.drop1a("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-126,-371.8,1,1,0,0,0,-0.5,0.2);
	this.instance_9._off = true;

	this.instance_10 = new lib.drop2_v2("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-124.95,-364,0.9876,0.9876,14.9998);
	this.instance_10._off = true;

	this.instance_11 = new lib.shock("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(-128.05,-385.85,1.3878,1.3878,-121.2396);

	this.instance_12 = new lib.sigh("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(-66.55,-231.45);
	this.instance_12.alpha = 0.6016;
	this.instance_12._off = true;

	this.instance_13 = new lib.heart("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(-128.65,-365.75,0.4532,0.4532);
	this.instance_13._off = true;

	this.instance_14 = new lib.angry("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(27.5,-368.95,0.5276,0.5276);
	this.instance_14._off = true;

	this.instance_15 = new lib.mc_punpun();
	this.instance_15.parent = this;
	this.instance_15.setTransform(-121.75,-401.2,1.1377,1.1377);

	this.instance_16 = new lib.concent_wrapper("synched",0,false);
	this.instance_16.parent = this;
	this.instance_16.setTransform(-38.05,-302.25,1,1,0,0,0,-0.5,-0.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-141.6,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-142,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,x:-143.3,y:-369.65,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-142.9,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-143.3,alpha:0},0).to({_off:true},1).wait(283));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(160).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-148.5,y:-383,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.2,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-145.85,y:-383.75,alpha:0,startPosition:19},0).to({_off:true},1).wait(262));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:-146.6,y:-376.1,alpha:0.5556},0).wait(1).to({x:-150.7,y:-384.35,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-152,y:-387.4,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-151.75,y:-386.45},0).wait(1).to({x:-150.75,y:-384.6},0).wait(1).to({x:-149.05,y:-381.45},0).wait(1).to({regX:0,regY:0,x:-146.6,y:-377.4},0).to({x:-147.35,y:-378.75},2).wait(8).to({regX:-0.2,regY:0.2,x:-147.1,y:-377.85,alpha:0.9298},0).wait(1).to({x:-146.05,y:-375.9,alpha:0.692},0).wait(1).to({x:-144.45,y:-373,alpha:0.339},0).wait(1).to({x:-143.3,y:-370.85,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-142.85,y:-370.55,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:-140.1,y:-353.2},0).wait(1).to({regX:-0.2,regY:0.2,x:-147.05,y:-366.6,alpha:0.5556},0).wait(1).to({x:-151.15,y:-374.85,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-152.45,y:-377.9,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-152.2,y:-376.95},0).wait(1).to({x:-151.2,y:-375.1},0).wait(1).to({x:-149.5,y:-371.95},0).wait(1).to({regX:0,regY:0,x:-147.05,y:-367.9},0).to({x:-147.8,y:-369.25},2).wait(3).to({regX:-0.2,regY:0.2,x:-147.55,y:-368.35,alpha:0.9298},0).wait(1).to({x:-146.5,y:-366.4,alpha:0.692},0).wait(1).to({x:-144.9,y:-363.5,alpha:0.339},0).wait(1).to({x:-143.75,y:-361.35,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-143.3,y:-361.05,alpha:0},0).to({_off:true},1).wait(195));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:-125,y:-368.1},0).wait(1).to({y:-364.25},0).wait(1).to({y:-361},0).wait(1).to({y:-358.35},0).wait(1).to({y:-356.25},0).wait(1).to({y:-354.75},0).wait(1).to({y:-353.85},0).wait(1).to({regX:-0.5,regY:0.2,x:-126,y:-352.8},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:-125,y:-353.6,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:-126,y:-352.8,alpha:0},0).to({_off:true},1).wait(153));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-156.375,y:-359.3875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-166.85,y:-357.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-124.95,y:-364,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-156.375,y:-363.775,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-166.85,y:-363.7,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-124.95,y:-364,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-156.375,y:-359.3875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-166.85,y:-357.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-124.95,y:-364,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-156.375,y:-363.775,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-166.85,y:-363.7,alpha:0.2188},0).to({_off:true},1).wait(110));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(351).to({_off:false},0).wait(1).to({x:-67.55,y:-230.45,alpha:1},0).wait(1).to({regX:0.9,x:-67.65,y:-229.5,alpha:0.8965},0).wait(1).to({x:-69,y:-228.3,alpha:0.7636},0).wait(1).to({x:-70.6,y:-226.85,alpha:0.6048},0).wait(1).to({x:-72.4,y:-225.25,alpha:0.4229},0).wait(1).to({x:-74.4,y:-223.4,alpha:0.2205},0).wait(1).to({regX:0,x:-77.55,y:-221.45,alpha:0},0).to({_off:true},1).wait(83));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-130.4,y:-379.9},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-133.65,y:-385.75},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-131.1,y:-383.6},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-130.55,y:-380.35},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-131.65,y:-375.75},0).to({scaleX:1,scaleY:1,x:-132.65,y:-379.75},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:-130.05,y:-378.75,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:-131.65,y:-379.5,alpha:0.1016},0).to({_off:true},1).wait(59));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-372.7},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-373.95},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(40));
...
p.nominalBounds = new cjs.Rectangle(-456.9,-702.5,826.5,852);
...
// stage content:
(lib._452_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:212,scene2:213,end2:429,scene3:430,end3:724,scene4:725,end4:951,scene5:952,end5:1150,scene6:1151,end6:1318,scene7:1319,end7:1536});
	...
	this.frame_983 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "れぇー……｡";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(27).call(this.frame_42).wait(14).call(this.frame_56).wait(36).call(this.frame_92).wait(17).call(this.frame_109).wait(44).call(this.frame_153).wait(19).call(this.frame_172).wait(40).call(this.frame_212).wait(1).call(this.frame_213).wait(24).call(this.frame_237).wait(37).call(this.frame_274).wait(30).call(this.frame_304).wait(39).call(this.frame_343).wait(24).call(this.frame_367).wait(31).call(this.frame_398).wait(31).call(this.frame_429).wait(1).call(this.frame_430).wait(40).call(this.frame_470).wait(45).call(this.frame_515).wait(42).call(this.frame_557).wait(42).call(this.frame_599).wait(38).call(this.frame_637).wait(23).call(this.frame_660).wait(22).call(this.frame_682).wait(42).call(this.frame_724).wait(1).call(this.frame_725).wait(54).call(this.frame_779).wait(40).call(this.frame_819).wait(45).call(this.frame_864).wait(36).call(this.frame_900).wait(27).call(this.frame_927).wait(24).call(this.frame_951).wait(1).call(this.frame_952).wait(31).call(this.frame_983).wait(45).call(this.frame_1028).wait(26).call(this.frame_1054).wait(40).call(this.frame_1094).wait(17).call(this.frame_1111).wait(39).call(this.frame_1150).wait(1).call(this.frame_1151).wait(41).call(this.frame_1192).wait(28).call(this.frame_1220).wait(44).call(this.frame_1264).wait(15).call(this.frame_1279).wait(39).call(this.frame_1318).wait(1).call(this.frame_1319).wait(29).call(this.frame_1348).wait(30).call(this.frame_1378).wait(30).call(this.frame_1408).wait(33).call(this.frame_1441).wait(25).call(this.frame_1466).wait(29).call(this.frame_1495).wait(41).call(this.frame_1536).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1541));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1536).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1541));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1522));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1526));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({scaleX:0.9917,scaleY:0.9917,x:119,y:153.7,alpha:0.6992},1).to({scaleX:1,scaleY:1,x:120,y:155,alpha:0.1016},2).to({_off:true},1).wait(1535));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(1438).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(63));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1478).wait(63));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1478).to({_off:false},0).wait(63));
	...
	this.timeline.addTween(cjs.Tween.get(this.ranko_finish_blur).wait(1478).to({_off:false},0).wait(1).to({regX:120,regY:155,x:120,y:155,alpha:0.8489},0).wait(1).to({alpha:0.8403},0).wait(1).to({alpha:0.8253},0).wait(1).to({alpha:0.8029},0).wait(1).to({alpha:0.7723},0).wait(1).to({alpha:0.7324},0).wait(1).to({alpha:0.6823},0).wait(1).to({alpha:0.6211},0).wait(1).to({alpha:0.5487},0).wait(1).to({alpha:0.4662},0).wait(1).to({alpha:0.3767},0).wait(1).to({alpha:0.2865},0).wait(1).to({alpha:0.2036},0).wait(1).to({alpha:0.1357},0).wait(1).to({alpha:0.0874},0).wait(1).to({alpha:0.0595},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0.0508},0).to({_off:true},1).wait(45));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(1478).to({_off:false},0).wait(63));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1466).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(63));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(1319).to({_off:false},0).to({alpha:0},7).to({_off:true},1).wait(214));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_12},{t:this.instance_11}]},599).to({state:[]},126).wait(816));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(16).to({regX:1,x:121,y:-3.2},0).wait(1).to({y:-6.85},0).wait(1).to({y:-12.75},0).wait(1).to({y:-20.7},0).wait(1).to({y:-30.4},0).wait(1).to({y:-41.5},0).wait(1).to({y:-53.55},0).wait(1).to({y:-65.9},0).wait(1).to({y:-78.05},0).wait(1).to({y:-89.25},0).wait(1).to({y:-98.95},0).wait(1).to({y:-106.45},0).wait(1).to({y:-111.3},0).wait(1).to({regX:0,x:120,y:-113},0).wait(63).to({y:-199.65},58,cjs.Ease.cubicInOut).to({_off:true},1).wait(1390));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(16).to({regX:1,x:121,y:308.45},0).wait(1).to({y:309.8},0).wait(1).to({y:312.05},0).wait(1).to({y:315.05},0).wait(1).to({y:318.75},0).wait(1).to({y:322.95},0).wait(1).to({y:327.5},0).wait(1).to({y:332.15},0).wait(1).to({y:336.75},0).wait(1).to({y:341},0).wait(1).to({y:344.65},0).wait(1).to({y:347.5},0).wait(1).to({y:349.35},0).wait(1).to({regX:0,x:120,y:350},0).wait(63).to({y:508},58,cjs.Ease.cubicInOut).to({_off:true},1).wait(1390));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(1151).to({_off:false},0).to({alpha:1},35,cjs.Ease.quadInOut).to({_off:true},133).wait(222));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(1151).to({_off:false},0).to({alpha:0.4492},35,cjs.Ease.quadInOut).to({_off:true},133).wait(222));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(15).to({_off:false},0).to({_off:true},136).wait(448).to({_off:false},0).to({_off:true},126).wait(816));

	// shine コピー 7
	this.instance_16 = new lib.mc_shine();
	this.instance_16.parent = this;
	this.instance_16.setTransform(103.05,96.55,1.9898,1.9898,0,0,0,131.8,174.9);
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(15).to({_off:false},0).wait(77).to({regY:175,scaleX:1.6442,scaleY:1.6442,x:103,y:189.1},58,cjs.Ease.cubicInOut).wait(63).to({regX:131.9,scaleX:1.1619,scaleY:1.1619,x:111.8,y:161.65},56,cjs.Ease.quadInOut).wait(161).to({regX:131.8,scaleX:1.6442,scaleY:1.6442,x:103,y:189.1},127,cjs.Ease.quadInOut).wait(42).to({regX:131.9,scaleX:1.3039,scaleY:1.3039,x:109.05,y:164.55},38,cjs.Ease.quadInOut).wait(89).to({regX:132,x:109.15,y:164.6,alpha:0.9985},0).wait(1).to({y:164.65,alpha:0.9939},0).wait(1).to({y:164.75,alpha:0.9859},0).wait(1).to({y:164.85,alpha:0.9742},0).wait(1).to({y:165.05,alpha:0.9585},0).wait(1).to({y:165.3,alpha:0.9385},0).wait(1).to({y:165.55,alpha:0.9139},0).wait(1).to({y:165.9,alpha:0.8845},0).wait(1).to({y:166.3,alpha:0.8502},0).wait(1).to({y:166.75,alpha:0.8112},0).wait(1).to({y:167.25,alpha:0.7676},0).wait(1).to({y:167.8,alpha:0.7201},0).wait(1).to({y:168.4,alpha:0.6694},0).wait(1).to({y:169,alpha:0.6167},0).wait(1).to({y:169.6,alpha:0.563},0).wait(1).to({y:170.2,alpha:0.5096},0).wait(1).to({y:170.8,alpha:0.4574},0).wait(1).to({y:171.4,alpha:0.4074},0).wait(1).to({y:171.95,alpha:0.3601},0).wait(1).to({y:172.45,alpha:0.316},0).wait(1).to({y:172.9,alpha:0.2752},0).wait(1).to({y:173.35,alpha:0.2378},0).wait(1).to({y:173.75,alpha:0.2038},0).wait(1).to({y:174.1,alpha:0.1731},0).wait(1).to({y:174.4,alpha:0.1455},0).wait(1).to({y:174.7,alpha:0.1209},0).wait(1).to({y:174.95,alpha:0.0991},0).wait(1).to({y:175.15,alpha:0.0799},0).wait(1).to({y:175.35,alpha:0.0632},0).wait(1).to({y:175.5,alpha:0.0488},0).wait(1).to({y:175.65,alpha:0.0365},0).wait(1).to({y:175.75,alpha:0.0262},0).wait(1).to({y:175.85,alpha:0.0178},0).wait(1).to({y:175.95,alpha:0.0111},0).wait(1).to({y:176,alpha:0.0061},0).wait(1).to({y:176.05,alpha:0.0027},0).wait(1).to({alpha:0.0007},0).wait(1).to({regX:131.9,x:109.05,alpha:0},0).to({_off:true},1).wait(777));

	// PC コピー 7
	this.instance_17 = new lib.PC("single",0);
	this.instance_17.parent = this;
	this.instance_17.setTransform(103.05,96.55,0.9948,0.9948,0,0,0,263.6,349.8);
	this.instance_17.alpha = 0;
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(15).to({_off:false},0).wait(77).to({startPosition:0},0).to({regX:263.8,regY:349.9,scaleX:0.822,scaleY:0.822,x:103.15,y:188.95,alpha:1},58,cjs.Ease.cubicInOut).wait(63).to({startPosition:0},0).to({regX:263.9,regY:350.1,scaleX:0.5809,scaleY:0.5809,x:111.85,y:161.7},56,cjs.Ease.quadInOut).wait(161).to({startPosition:0},0).to({regX:263.8,regY:349.9,scaleX:0.822,scaleY:0.822,x:103.15,y:188.95},127,cjs.Ease.quadInOut).wait(42).to({startPosition:0},0).to({regX:263.9,regY:350,scaleX:0.6519,scaleY:0.6519,x:109.1,y:164.5},38,cjs.Ease.quadInOut).wait(88).to({startPosition:0},0).wait(1).to({regX:264,x:109.15,y:164.55,alpha:0.9985},0).wait(1).to({y:164.6,alpha:0.9939},0).wait(1).to({y:164.7,alpha:0.9859},0).wait(1).to({y:164.8,alpha:0.9742},0).wait(1).to({y:165,alpha:0.9585},0).wait(1).to({y:165.25,alpha:0.9385},0).wait(1).to({y:165.5,alpha:0.9139},0).wait(1).to({y:165.85,alpha:0.8845},0).wait(1).to({y:166.25,alpha:0.8502},0).wait(1).to({y:166.7,alpha:0.8112},0).wait(1).to({y:167.2,alpha:0.7676},0).wait(1).to({y:167.75,alpha:0.7201},0).wait(1).to({y:168.35,alpha:0.6694},0).wait(1).to({y:168.95,alpha:0.6167},0).wait(1).to({y:169.55,alpha:0.563},0).wait(1).to({y:170.15,alpha:0.5096},0).wait(1).to({y:170.75,alpha:0.4574},0).wait(1).to({y:171.35,alpha:0.4074},0).wait(1).to({y:171.9,alpha:0.3601},0).wait(1).to({y:172.4,alpha:0.316},0).wait(1).to({y:172.85,alpha:0.2752},0).wait(1).to({y:173.3,alpha:0.2378},0).wait(1).to({y:173.7,alpha:0.2038},0).wait(1).to({y:174.05,alpha:0.1731},0).wait(1).to({y:174.35,alpha:0.1455},0).wait(1).to({y:174.65,alpha:0.1209},0).wait(1).to({y:174.9,alpha:0.0991},0).wait(1).to({y:175.1,alpha:0.0799},0).wait(1).to({y:175.3,alpha:0.0632},0).wait(1).to({y:175.45,alpha:0.0488},0).wait(1).to({y:175.6,alpha:0.0365},0).wait(1).to({y:175.7,alpha:0.0262},0).wait(1).to({y:175.8,alpha:0.0178},0).wait(1).to({y:175.9,alpha:0.0111},0).wait(1).to({y:175.95,alpha:0.0061},0).wait(1).to({y:176,alpha:0.0027},0).wait(1).to({alpha:0.0007},0).wait(1).to({regX:263.9,x:109.1,alpha:0},0).to({_off:true},1).wait(777));

	// ch コピー 8
	this.ch1 = new lib.character1_container();
	this.ch1.name = "ch1";
	this.ch1.parent = this;
	this.ch1.setTransform(149.8,313.4,0.9948,0.9948,0,0,0,0.8,0.8);
	this.ch1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({_off:false},0).wait(77).to({scaleX:0.822,scaleY:0.822,x:141.7,y:368.15},58,cjs.Ease.cubicInOut).wait(63).to({regX:0.7,regY:0.6,scaleX:0.5809,scaleY:0.5809,x:139.2,y:288.3},56,cjs.Ease.quadInOut).wait(161).to({regX:0.8,regY:0.8,scaleX:0.822,scaleY:0.822,x:141.7,y:368.15},127,cjs.Ease.quadInOut).wait(42).to({regX:0.7,regY:0.7,scaleX:0.6519,scaleY:0.6519,x:139.7,y:306.6},38,cjs.Ease.quadInOut).wait(89).to({regX:-36.2,regY:-286.2,x:115.65,y:119.6,alpha:0.9985},0).wait(1).to({y:119.65,alpha:0.9939},0).wait(1).to({y:119.75,alpha:0.9859},0).wait(1).to({y:119.85,alpha:0.9742},0).wait(1).to({y:120.05,alpha:0.9585},0).wait(1).to({y:120.3,alpha:0.9385},0).wait(1).to({y:120.55,alpha:0.9139},0).wait(1).to({y:120.9,alpha:0.8845},0).wait(1).to({y:121.3,alpha:0.8502},0).wait(1).to({y:121.75,alpha:0.8112},0).wait(1).to({y:122.25,alpha:0.7676},0).wait(1).to({y:122.8,alpha:0.7201},0).wait(1).to({y:123.4,alpha:0.6694},0).wait(1).to({y:124,alpha:0.6167},0).wait(1).to({y:124.6,alpha:0.563},0).wait(1).to({y:125.2,alpha:0.5096},0).wait(1).to({y:125.8,alpha:0.4574},0).wait(1).to({y:126.4,alpha:0.4074},0).wait(1).to({y:126.95,alpha:0.3601},0).wait(1).to({y:127.45,alpha:0.316},0).wait(1).to({y:127.9,alpha:0.2752},0).wait(1).to({y:128.35,alpha:0.2378},0).wait(1).to({y:128.75,alpha:0.2038},0).wait(1).to({y:129.1,alpha:0.1731},0).wait(1).to({y:129.4,alpha:0.1455},0).wait(1).to({y:129.7,alpha:0.1209},0).wait(1).to({y:129.95,alpha:0.0991},0).wait(1).to({y:130.15,alpha:0.0799},0).wait(1).to({y:130.35,alpha:0.0632},0).wait(1).to({y:130.5,alpha:0.0488},0).wait(1).to({y:130.65,alpha:0.0365},0).wait(1).to({y:130.75,alpha:0.0262},0).wait(1).to({y:130.85,alpha:0.0178},0).wait(1).to({y:130.95,alpha:0.0111},0).wait(1).to({y:131,alpha:0.0061},0).wait(1).to({y:131.05,alpha:0.0027},0).wait(1).to({alpha:0.0007},0).wait(1).to({regX:0.7,regY:0.7,x:139.7,y:318.1,alpha:0},0).to({_off:true},1).wait(777));

	// shine
	this.instance_18 = new lib.mc_shine();
	this.instance_18.parent = this;
	this.instance_18.setTransform(113,203.1,1.6442,1.6442,0,0,0,131.8,175);
	this.instance_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(724).to({_off:false},0).wait(2).to({regX:132,x:113.35},0).wait(1).to({y:203.05},0).wait(1).to({y:202.95},0).wait(1).to({y:202.75},0).wait(1).to({y:202.55},0).wait(1).to({y:202.25},0).wait(1).to({y:201.9},0).wait(1).to({y:201.5},0).wait(1).to({y:201.05},0).wait(1).to({y:200.5},0).wait(1).to({y:199.85},0).wait(1).to({y:199.2},0).wait(1).to({y:198.5},0).wait(1).to({y:197.75},0).wait(1).to({y:197},0).wait(1).to({y:196.25},0).wait(1).to({y:195.55},0).wait(1).to({y:194.85},0).wait(1).to({y:194.15},0).wait(1).to({y:193.55},0).wait(1).to({y:193},0).wait(1).to({y:192.45},0).wait(1).to({y:192},0).wait(1).to({y:191.55},0).wait(1).to({y:191.15},0).wait(1).to({y:190.8},0).wait(1).to({y:190.5},0).wait(1).to({y:190.25},0).wait(1).to({y:190},0).wait(1).to({y:189.8},0).wait(1).to({y:189.65},0).wait(1).to({y:189.5},0).wait(1).to({y:189.35},0).wait(1).to({y:189.3},0).wait(1).to({y:189.2},0).wait(1).to({y:189.15},0).wait(2).to({regX:131.8,x:113,y:189.1},0).wait(190).to({regX:132,scaleX:1.6465,scaleY:1.6465,x:113.4,y:189.15},0).wait(1).to({scaleX:1.6493,scaleY:1.6493,x:113.35,y:189.1},0).wait(1).to({scaleX:1.6526,scaleY:1.6526,x:113.4},0).wait(1).to({scaleX:1.6565,scaleY:1.6565,x:113.35,y:189.15},0).wait(1).to({scaleX:1.661,scaleY:1.661},0).wait(1).to({scaleX:1.6662,scaleY:1.6662,x:113.4},0).wait(1).to({scaleX:1.6721,scaleY:1.6721,x:113.35},0).wait(1).to({scaleX:1.6786,scaleY:1.6786,x:113.4},0).wait(1).to({scaleX:1.6858,scaleY:1.6858,x:113.35},0).wait(1).to({scaleX:1.6935,scaleY:1.6935,x:113.4},0).wait(1).to({scaleX:1.7017,scaleY:1.7017,y:189.2},0).wait(1).to({scaleX:1.7101,scaleY:1.7101,x:113.45},0).wait(1).to({scaleX:1.7185,scaleY:1.7185},0).wait(1).to({scaleX:1.7268,scaleY:1.7268},0).wait(1).to({scaleX:1.7347,scaleY:1.7347},0).wait(1).to({scaleX:1.7421,scaleY:1.7421},0).wait(1).to({scaleX:1.749,scaleY:1.749},0).wait(1).to({scaleX:1.7552,scaleY:1.7552,y:189.25},0).wait(1).to({scaleX:1.7607,scaleY:1.7607,y:189.2},0).wait(1).to({scaleX:1.7656,scaleY:1.7656,y:189.25},0).wait(1).to({scaleX:1.7699,scaleY:1.7699,x:113.5},0).wait(1).to({scaleX:1.7736,scaleY:1.7736,x:113.45,y:189.3},0).wait(1).to({scaleX:1.7768,scaleY:1.7768,x:113.5},0).wait(1).to({scaleX:1.7795,scaleY:1.7795,y:189.25},0).wait(1).to({scaleX:1.7817,scaleY:1.7817,y:189.3},0).wait(1).to({scaleX:1.7835,scaleY:1.7835,x:113.45,y:189.25},0).wait(1).to({scaleX:1.7849,scaleY:1.7849,x:113.5,y:189.3},0).wait(1).to({scaleX:1.7859,scaleY:1.7859},0).wait(1).to({scaleX:1.7866,scaleY:1.7866,y:189.25},0).wait(1).to({scaleX:1.787,scaleY:1.787,y:189.3},0).wait(1).to({regX:131.8,scaleX:1.7872,scaleY:1.7872,x:113.1,y:189.25},0).wait(168).to({regY:174.8,scaleX:1.9458,scaleY:1.9458,x:113.45,y:189.85},69,cjs.Ease.quadInOut).wait(99).to({regX:131.9,regY:175,scaleX:1.3039,scaleY:1.3039,x:109.05,y:164.55},0).to({_off:true},160).wait(62));

	// PC
	this.instance_19 = new lib.PC("single",0);
	this.instance_19.parent = this;
	this.instance_19.setTransform(113.15,202.95,0.822,0.822,0,0,0,263.8,349.9);
	this.instance_19._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(724).to({_off:false},0).to({startPosition:0},1).wait(1).to({regX:264,regY:350,x:113.3,y:203.05},0).wait(1).to({y:203},0).wait(1).to({y:202.9},0).wait(1).to({y:202.7},0).wait(1).to({y:202.5},0).wait(1).to({y:202.2},0).wait(1).to({y:201.85},0).wait(1).to({y:201.45},0).wait(1).to({y:201},0).wait(1).to({y:200.45},0).wait(1).to({y:199.8},0).wait(1).to({y:199.15},0).wait(1).to({y:198.45},0).wait(1).to({y:197.7},0).wait(1).to({y:196.95},0).wait(1).to({y:196.2},0).wait(1).to({y:195.5},0).wait(1).to({y:194.8},0).wait(1).to({y:194.1},0).wait(1).to({y:193.5},0).wait(1).to({y:192.95},0).wait(1).to({y:192.4},0).wait(1).to({y:191.95},0).wait(1).to({y:191.5},0).wait(1).to({y:191.1},0).wait(1).to({y:190.75},0).wait(1).to({y:190.45},0).wait(1).to({y:190.2},0).wait(1).to({y:189.95},0).wait(1).to({y:189.75},0).wait(1).to({y:189.6},0).wait(1).to({y:189.45},0).wait(1).to({y:189.3},0).wait(1).to({y:189.25},0).wait(1).to({y:189.15},0).wait(1).to({y:189.1},0).wait(1).to({startPosition:0},0).wait(1).to({regX:263.8,regY:349.9,x:113.15,y:188.95},0).wait(189).to({startPosition:0},0).wait(1).to({regX:264,regY:350,scaleX:0.8232,scaleY:0.8232,x:113.35,y:189.1},0).wait(1).to({scaleX:0.8245,scaleY:0.8245},0).wait(1).to({scaleX:0.8262,scaleY:0.8262,y:189.05},0).wait(1).to({scaleX:0.8282,scaleY:0.8282,y:189.1},0).wait(1).to({scaleX:0.8304,scaleY:0.8304},0).wait(1).to({scaleX:0.833,scaleY:0.833},0).wait(1).to({scaleX:0.8359,scaleY:0.8359},0).wait(1).to({scaleX:0.8392,scaleY:0.8392},0).wait(1).to({scaleX:0.8428,scaleY:0.8428,y:189.15},0).wait(1).to({scaleX:0.8467,scaleY:0.8467},0).wait(1).to({scaleX:0.8507,scaleY:0.8507,x:113.4,y:189.1},0).wait(1).to({scaleX:0.8549,scaleY:0.8549,y:189.15},0).wait(1).to({scaleX:0.8592,scaleY:0.8592},0).wait(1).to({scaleX:0.8633,scaleY:0.8633},0).wait(1).to({scaleX:0.8673,scaleY:0.8673},0).wait(1).to({scaleX:0.871,scaleY:0.871,x:113.45},0).wait(1).to({scaleX:0.8744,scaleY:0.8744,y:189.2},0).wait(1).to({scaleX:0.8775,scaleY:0.8775,x:113.4,y:189.15},0).wait(1).to({scaleX:0.8803,scaleY:0.8803,x:113.45,y:189.2},0).wait(1).to({scaleX:0.8827,scaleY:0.8827},0).wait(1).to({scaleX:0.8849,scaleY:0.8849},0).wait(1).to({scaleX:0.8867,scaleY:0.8867},0).wait(1).to({scaleX:0.8883,scaleY:0.8883},0).wait(1).to({scaleX:0.8896,scaleY:0.8896,y:189.15},0).wait(1).to({scaleX:0.8907,scaleY:0.8907,y:189.2},0).wait(1).to({scaleX:0.8916,scaleY:0.8916},0).wait(1).to({scaleX:0.8923,scaleY:0.8923},0).wait(1).to({scaleX:0.8928,scaleY:0.8928},0).wait(1).to({scaleX:0.8932,scaleY:0.8932},0).wait(1).to({scaleX:0.8934,scaleY:0.8934},0).wait(1).to({regX:263.8,regY:349.8,scaleX:0.8935,scaleY:0.8935,x:113.25,y:189.05},0).wait(168).to({startPosition:0},0).to({regX:263.6,scaleX:0.9728,scaleY:0.9728,x:113.45,y:190},69,cjs.Ease.quadInOut).wait(99).to({regX:263.9,regY:350,scaleX:0.6519,scaleY:0.6519,x:109.1,y:164.5},0).to({_off:true},160).wait(62));

	// ch
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(151.7,382.15,0.822,0.822,0,0,0,0.8,0.8);
	this.ch2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(724).to({_off:false},0).wait(2).to({regX:-36.2,regY:-286.2,x:121.3,y:146.2},0).wait(1).to({y:146.15},0).wait(1).to({y:146.05},0).wait(1).to({y:145.85},0).wait(1).to({y:145.65},0).wait(1).to({y:145.35},0).wait(1).to({y:145},0).wait(1).to({y:144.6},0).wait(1).to({y:144.15},0).wait(1).to({y:143.6},0).wait(1).to({y:142.95},0).wait(1).to({y:142.3},0).wait(1).to({y:141.6},0).wait(1).to({y:140.85},0).wait(1).to({y:140.1},0).wait(1).to({y:139.35},0).wait(1).to({y:138.65},0).wait(1).to({y:137.95},0).wait(1).to({y:137.25},0).wait(1).to({y:136.65},0).wait(1).to({y:136.1},0).wait(1).to({y:135.55},0).wait(1).to({y:135.1},0).wait(1).to({y:134.65},0).wait(1).to({y:134.25},0).wait(1).to({y:133.9},0).wait(1).to({y:133.6},0).wait(1).to({y:133.35},0).wait(1).to({y:133.1},0).wait(1).to({y:132.9},0).wait(1).to({y:132.75},0).wait(1).to({y:132.6},0).wait(1).to({y:132.45},0).wait(1).to({y:132.4},0).wait(1).to({y:132.3},0).wait(1).to({y:132.25},0).wait(2).to({regX:0.8,regY:0.8,x:151.7,y:368.15},0).wait(190).to({regX:-36.2,regY:-286.2,scaleX:0.8232,scaleY:0.8232,x:121.3,y:132.1},0).wait(1).to({scaleX:0.8245,scaleY:0.8245,y:132.05},0).wait(1).to({scaleX:0.8262,scaleY:0.8262,y:131.95},0).wait(1).to({scaleX:0.8282,scaleY:0.8282,y:131.8},0).wait(1).to({scaleX:0.8304,scaleY:0.8304,x:121.35,y:131.65},0).wait(1).to({scaleX:0.833,scaleY:0.833,x:121.4,y:131.5},0).wait(1).to({scaleX:0.8359,scaleY:0.8359,x:121.45,y:131.25},0).wait(1).to({scaleX:0.8392,scaleY:0.8392,y:131.05},0).wait(1).to({scaleX:0.8428,scaleY:0.8428,x:121.5,y:130.8},0).wait(1).to({scaleX:0.8467,scaleY:0.8467,x:121.55,y:130.55},0).wait(1).to({scaleX:0.8507,scaleY:0.8507,x:121.6,y:130.25},0).wait(1).to({scaleX:0.8549,scaleY:0.8549,x:121.65,y:130},0).wait(1).to({scaleX:0.8592,scaleY:0.8592,x:121.7,y:129.7},0).wait(1).to({scaleX:0.8633,scaleY:0.8633,x:121.75,y:129.4},0).wait(1).to({scaleX:0.8673,scaleY:0.8673,y:129.2},0).wait(1).to({scaleX:0.871,scaleY:0.871,x:121.8,y:128.95},0).wait(1).to({scaleX:0.8744,scaleY:0.8744,x:121.85,y:128.7},0).wait(1).to({scaleX:0.8775,scaleY:0.8775,x:121.9,y:128.45},0).wait(1).to({scaleX:0.8803,scaleY:0.8803,x:121.95,y:128.3},0).wait(1).to({scaleX:0.8827,scaleY:0.8827,y:128.1},0).wait(1).to({scaleX:0.8849,scaleY:0.8849,y:128},0).wait(1).to({scaleX:0.8867,scaleY:0.8867,x:122,y:127.9},0).wait(1).to({scaleX:0.8883,scaleY:0.8883,y:127.75},0).wait(1).to({scaleX:0.8896,scaleY:0.8896,x:122.05,y:127.7},0).wait(1).to({scaleX:0.8907,scaleY:0.8907,y:127.55},0).wait(1).to({scaleX:0.8916,scaleY:0.8916,y:127.5},0).wait(1).to({scaleX:0.8923,scaleY:0.8923,y:127.45},0).wait(1).to({scaleX:0.8928,scaleY:0.8928,x:122.1},0).wait(1).to({scaleX:0.8932,scaleY:0.8932,x:122.05,y:127.4},0).wait(1).to({scaleX:0.8934,scaleY:0.8934},0).wait(1).to({regX:0.8,regY:0.8,scaleX:0.8935,scaleY:0.8935,x:155.1,y:383.8},0).wait(168).to({regX:1,regY:1,scaleX:0.9728,scaleY:0.9728,x:159.15,y:402.05},69,cjs.Ease.quadInOut).wait(99).to({regX:0.7,regY:0.7,scaleX:0.6519,scaleY:0.6519,x:139.7,y:306.6},0).to({_off:true},160).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},1466).wait(75));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},1478).wait(58).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-278,-720,898,1383);
// library properties:
lib.properties = {
	id: '_452_2',
	width: 240,
